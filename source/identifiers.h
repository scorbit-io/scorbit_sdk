...
// SPEC-0007 "Wi-Fi Capture Lifecycle" (api#4028): 410 on capture ingest means the server has
// CLOSED this run, and 404 that it does not know the run at all. Both are terminal for the run
// -- the device stops rather than retrying, because there is nothing to retry into. See
// wifiIngestStatusEndsRun().
